...
const int PRNG_31bit::a = 16807;
const unsigned long PRNG_31bit::m = 2147483647L;
long PRNG_31bit::seed_ = 1;

const double UnitDoubleRandomNumberGenerator::unitScale = 1. / (double)0x7FFFFFFF;
